...
Para fazer um clone é necessário apenas duas condições, o endereço do repositório e obviamente permissão para fazer tal processo. Se o projeto for público você pode fazer o repositório sem pedir a permissão do dono. Abaixo segue os dois principais comandos para realizar um clone:
